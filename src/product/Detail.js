...
export default function Details() {
	...
	useEffect(() => {
		axios.get("http://localhost/web2m/laravel8/laravel8/public/api/product/detail/" + pramas.id)
			.then(res => {
				// console.log(res);
				...
				<div>
					...
					<div class="col-sm-7">
						<div class="product-information">
							...
							<p><b>Condition:</b> {renderStatus()}</p>
							<p><b>Brand:</b> {hanhleInputB()} </p>
				...
				<div class="row">
					<div class="col-sm-9 padding-right">
						<div class="product-details">
							...
							{/* <div class="col-sm-5">
								<div class="view-product">
									<img src={"http://localhost/web2m/laravel8/laravel8/public/upload/product/13/"} alt="" />
									<a href="images/product-details/1.jpg" rel="prettyPhoto"><h3>ZOOM</h3></a>
